...
public class Tracking {
	...
	public static final String ACTION_SHOW_GAME_END_DIALOG = "ShowGameEndDialog";
	...
	public static final String CATEGORY_STRANGE = "Strange";
	public static final String ACTION_UNSUPPORTED_DRAW_PICTURE = "UnsupportedDrawPicture";
	
	public static final String CATEGORY_PAID_APP = "PaidApp";
	public static final String ACTION_LICENSE = "License";
	public static final String LABEL_DONT_ALLOW = "DontAllow";
	public static final String LABEL_APPLICATION_ERROR = "ApplicationError";
